				...
				<span class="align-middle"><img src="/assets/img/logos/logo.jpg" alt="{{Auth::user()->name}}" height="60"></span>
                   ...
                   <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item active">
						...
						<li class="sidebar-item"><a class="sidebar-link" href="{{route('getDebtors')}}">Debtors</a></li>
								...
								<table id="datatables-dashboard-projects" class="table table-striped my-0">
									...
									<tbody>
                                        @foreach ($debtors as $fresh)
											...
											@switch($fresh->membergroup_id)
												...
												@case(4)
													...
													@break
												@case(5)
													<td><span class="badge badge-info">{{$fresh->membergroup->name}}</span></td>
												@default
										...
										<div class="dropdown show">
											...
											<a class="dropdown-item" href="{{route('adminEditUser', $fresh->id)}}"><i class="fas fa-user-edit"></i> &nbsp; Update</a>
